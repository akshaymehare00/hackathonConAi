...
const Analytics = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const interviewId = localStorage.getItem('cvResponse');
        const response = await axios.get(`http://13.127.144.141:3004/api/interviews/get-interview_by_id/?interview_id=${interviewId}`);
